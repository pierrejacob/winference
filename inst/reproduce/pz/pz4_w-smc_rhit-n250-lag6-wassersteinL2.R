...
# g
# #
# g <- ggplot(wsmc.df, aes(x = c, group = step, colour = step)) + geom_density(aes(y = ..density..))
# g <- g +  theme(legend.position = "none")
# g <- g + xlab(expression(c))
# g
#
# g <- ggplot(wsmc.df, aes(x = e, group = step, colour = step)) + geom_density(aes(y = ..density..))
# g <- g +  theme(legend.position = "none")
# g <- g + xlab(expression(c))
# g
