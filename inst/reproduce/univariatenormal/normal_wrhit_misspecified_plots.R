...
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wmcmc.threshold0.5.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wmcmc.threshold0.25.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wmcmc.threshold0.1.RData")
## load results from ABC-rhit
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wrhit.threshold0.5.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wrhit.threshold0.25.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/gammadata.n10.wrhit.threshold0.1.RData")
...
g <- g + geom_density(data = rhitres1$chains_df, colour = "orange")
g <- g + geom_density(data = rhitres2$chains_df, colour = "orange")
g <- g + geom_density(data = rhitres3$chains_df, colour = "orange")
g
