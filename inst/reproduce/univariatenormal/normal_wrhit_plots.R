...
load("~/Dropbox/ABCD/Results/univariatenormal/normaldata.n10.wrhit.threshold0.5.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/normaldata.n10.wrhit.threshold0.25.RData")
load("~/Dropbox/ABCD/Results/univariatenormal/normaldata.n10.wrhit.threshold0.1.RData")
