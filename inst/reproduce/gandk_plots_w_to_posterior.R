...
filename <- paste0(prefix, "gandk.n", nobservations, ".w2posterior.RData")
# n_w_comp <- 50
...
g
ggsave(filename = paste0(prefix, "gandk.n", nobservations, ".w2post.pdf"), plot = g, width = 2*fig.width, height = fig.height)
