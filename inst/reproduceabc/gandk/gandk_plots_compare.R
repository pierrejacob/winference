...
g
#ggsave(filename = paste0(prefix, "compare.gandk_marginal1.pdf"), plot = g, width = fig.width, height = fig.height)
...
g
#ggsave(filename = paste0(prefix, "compare.gandk_marginal2.pdf"), plot = g, width = fig.width, height = fig.height)
...
g
#ggsave(filename = paste0(prefix, "compare.gandk_marginal3.pdf"), plot = g, width = fig.width, height = fig.height)
...
g
#ggsave(filename = paste0(prefix, "compare.gandk_marginal4.pdf"), plot = g, width = fig.width, height = fig.height)
...
# g <- g + geom_density(data = wsmc.df %>% filter(step == step), aes(y = ..density.., fill = "Wasserstein", colour = "Wasserstein"), alpha = 0.5)
# g <- g + scale_color_manual(name = "", values = my_colors) + scale_fill_manual(name = "", values = my_colors) + xlab("a")
# g <- g + geom_label(data = data.frame(x = c(3.17, 2.83), y = c(5, 5.7), method = c("Wasserstein", "Posterior")),
#                     aes(x = x, y = y, colour = method, label = method), size = 8) + theme(legend.position = "none")
# g <- g + geom_vline(xintercept = true_theta[1])
# g
# # ggsave(filename = paste0(prefix, "wsmc.large.gandk_marginal1.pdf"), plot = g, width = fig.width, height = fig.height)
#
# g <- ggplot(mcmc.df, aes(x = B)) + geom_density(aes(y = ..density.., fill = "Posterior", colour = "Posterior"), alpha = 0.5)
# g <- g + geom_density(data = wsmc.df %>% filter(step == step), aes(y = ..density.., fill = "Wasserstein", colour = "Wasserstein"), alpha = 0.5)
# g <- g + scale_color_manual(name = "", values = my_colors) + scale_fill_manual(name = "", values = my_colors) + xlab("b")
# g <- g + geom_label(data = data.frame(x = c(1.35, 1.25), y = c(2.35, 2.85), method = c("Wasserstein", "Posterior")),
#                     aes(x = x, y = y, colour = method, label = method), size = 8) + theme(legend.position = "none")
# g <- g + geom_vline(xintercept = true_theta[2])
# g
# # ggsave(filename = paste0(prefix, "wsmc.large.gandk_marginal2.pdf"), plot = g, width = fig.width, height = fig.height)
#
#
# g <- ggplot(mcmc.df, aes(x = g)) + geom_density(aes(y = ..density.., fill = "Posterior", colour = "Posterior"), alpha = 0.5)
# g <- g + geom_density(data = wsmc.df %>% filter(step == step), aes(y = ..density.., fill = "Wasserstein", colour = "Wasserstein"), alpha = 0.5)
# g <- g + scale_color_manual(name = "", values = my_colors) + scale_fill_manual(name = "", values = my_colors) + xlab("g")
# g <- g + geom_label(data = data.frame(x = c(2.75, 2.5), y = c(1.25, 1.75), method = c("Wasserstein", "Posterior")),
#                     aes(x = x, y = y, colour = method, label = method), size = 8) + theme(legend.position = "none")
# g <- g + geom_vline(xintercept = true_theta[3])
# g
# # ggsave(filename = paste0(prefix, "wsmc.large.gandk_marginal3.pdf"), plot = g, width = fig.width, height = fig.height)
#
#
# g <- ggplot(mcmc.df, aes(x = k)) + geom_density(aes(y = ..density.., fill = "Posterior", colour = "Posterior"), alpha = 0.5)
# g <- g + geom_density(data = wsmc.df %>% filter(step == step), aes(y = ..density.., fill = "Wasserstein", colour = "Wasserstein"), alpha = 0.5)
# g <- g + scale_color_manual(name = "", values = my_colors) + scale_fill_manual(name = "", values = my_colors) + xlab("k")
# g <- g + geom_label(data = data.frame(x = c(0.7, 0.65), y = c(4, 5), method = c("Wasserstein", "Posterior")),
#                     aes(x = x, y = y, colour = method, label = method), size = 8) + theme(legend.position = "none")
# g <- g + geom_vline(xintercept = true_theta[4])
# g
# # ggsave(filename = paste0(prefix, "wsmc.large.gandk_marginal4.pdf"), plot = g, width = fig.width, height = fig.height)
